...
namespace LoginV1.Controller
{
    internal class UsuarioController
    {
        ...
        public List<Usuario> ObtenerUsuarios(string filtro)
        {
            ...
            {
                connection.Open();
                string query = "SELECT * FROM Usuarios WHERE nombre_completo LIKE @Filtro OR username LIKE @Filtro";
                using (var cmd = new SQLiteCommand(query, connection))
                {
        ...
        public bool AgregarUsuario(Usuario usuario)
        {
            using (var connection = SQLiteConnectionManager.GetConnection())
            {
                ...
                using (var cmd = new SQLiteCommand(query, connection))
                {
                    ...
                    cmd.Parameters.AddWithValue("@TipoUsuario", usuario.TipoUsuario); // Ej: "Administrador"
                    cmd.Parameters.AddWithValue("@Username", usuario.Username);
                    cmd.Parameters.AddWithValue("@Password", usuario.Password); // Usa texto plano 
